...
int main(int argc, char *argv[]) {
  ...
  twolayer6_init(nchan,input_data[0],input_data[1],atof(argv[2]),min[1],max[1]);

  devo2_init(&dstruct,6,min,max,popingen,0.2,0.8,twolayer6_evaluate);
  ...
  twolayer6_evaluate(dstruct.best_vector);
