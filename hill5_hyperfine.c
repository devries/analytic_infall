...
int main(int argc, char *argv[]) {
  ...
  if(argc!=10) {
    fprintf(stderr, "Usage: %s <inputfilename> <frequency> <vmin> <vmax> <popingeneration> <generationspercheck> <checksperconv> <hyperfine-def> <outputfile>\n", argv[0]);
    exit(1);
  }
